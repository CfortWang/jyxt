...
Vue.component('ibps-list-item', () => import('./ibps-list/list-item.vue'))
Vue.component('ibps-list-item-meta', () => import('./ibps-list/list-item-meta.vue'))
Vue.component('ibps-hyperlink', () => import('./ibps-link'))
Vue.component('ibps-help', () => import('./ibps-help/index.vue'))

Vue.component('ibps-steps', () => import('./ibps-steps/steps'))
Vue.component('ibps-step-pane', () => import('./ibps-steps/step-pane'))
