  ...
  <div class="panel-body">
    ...
    <div>
      <div class="buttons ibps-pb-5 ibps-tr">
        <el-button type="success" size="mini" plain icon="el-icon-circle-plus-outline" @click="editTrigerFlow()">添加流程</el-button>
        <el-button  size="mini" plain icon="el-icon-circle-close" type="danger" @click="cleanTrigerFlow()">清空流程</el-button>
      </div>
