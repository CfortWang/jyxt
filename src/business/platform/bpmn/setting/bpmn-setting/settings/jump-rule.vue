  ...
  <div class="panel-default">
    <div class="panel-body">
      <div class="buttons ibps-pb-5 ibps-tr">
        <el-button type="success" size="mini" plain icon="el-icon-circle-plus-outline" @click="editRule()">添加规则</el-button>
        <el-button  size="mini" plain icon="el-icon-circle-close" type="danger" @click="cleanRule">清空规则</el-button>
      </div>
