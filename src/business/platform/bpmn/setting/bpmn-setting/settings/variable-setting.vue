<template>
  <div class="panel-body">
    <div class="buttons ibps-pb-5 ibps-tr">
      <el-button type="success" size="mini" plain icon="el-icon-circle-plus-outline" @click="editVariable()">添加变量</el-button>
      <el-button  size="mini" plain icon="el-icon-circle-close" type="danger" @click="cleanVariable">清空变量</el-button>
    </div>
