      ...
      <template v-if="nodeType==='start'">
        <el-tab-pane label="开始事件" name="start">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <bpmn-form-var size="mini" :data="formVars" :props="{label: 'name'}" @callback="(data)=> handleFormVar('start',data)" />
            </el-col>
          </el-row>
      ...
      <template v-else-if="nodeType==='userTask'|| nodeType==='signTask'">
        <el-tab-pane label="前置脚本" name="start">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" style="position:relative">
              <bpmn-form-var size="mini" :data="formVars" :props="{label: 'name'}" @callback="(data)=> handleFormVar('create',data)" />
            </el-col>
          </el-row>
        ...
        <el-tab-pane label="后置脚本" name="afterScript">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" style="position:relative">
              <bpmn-form-var size="mini" :data="formVars" :props="{label: 'name'}" @callback="(data)=> handleFormVar('complete',data)" />
            </el-col>
          </el-row>
      ...
      <template v-else-if="nodeType==='end'">
        <el-tab-pane label="结束事件 " name="start">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" style="position:relative">
              <bpmn-form-var size="mini" :data="formVars" :props="{label: 'name'}" @callback="(data)=> handleFormVar('end',data)" />
            </el-col>
          </el-row>
      ...
      <template v-else>
        <el-tab-pane label="节点脚本" name="start">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" style="position:relative">
              <bpmn-form-var size="mini" :data="formVars" :props="{label: 'name'}" @callback="(data)=> handleFormVar('node',data)" />
            </el-col>
          </el-row>
