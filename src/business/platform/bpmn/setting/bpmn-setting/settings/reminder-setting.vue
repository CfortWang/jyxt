<template>
  <div class=" panel-body">
    <div class="buttons ibps-pb-5 ibps-tr">
      <el-button type="success" size="mini" plain icon="el-icon-circle-plus-outline" @click="editReminder()">添加催办</el-button>
      <el-button  size="mini" plain icon="el-icon-circle-close" type="danger" @click="cleanReminder">清空催办</el-button>
    </div>
