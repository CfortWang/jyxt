...
'</label>' +
'<div class="bpp-field-wrapper" data-disable="isDisabled"> ' +
  '<input id="camunda-callable-element-ref" type="text" name="callableElementRef" data-disable="isDisabled" />' +
'</div>'
  ...
  entries.push({
    ...
    validate: function(element, values, node) {
      ...
      var type = getCallableType(element)
      document.getElementById('camunda-callable-element-ref').disabled = 'disabled'
