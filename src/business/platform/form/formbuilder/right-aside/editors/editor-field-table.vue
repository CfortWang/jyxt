...
<script>
import FIELD_TYPES, { tableFieldTypes } from '../../../constants/fieldTypes'
import BUTTON_TYPES, { tableButtonTypes } from '@/business/platform/form/constants/tableButtonTypes'
...
export default {
  ...
  methods: {
    ...
    settingButton(index) {
      ...
      this.title = this.$utils.isNotEmpty(index) ? '设置按钮' : '添加按钮'
      this.buttonDialogVisible = true
    },
