...
<template>
  ...
  >
    <div v-if="dialogVisible">
      <el-form v-if="verify" ref="formulaVerify" :model="form" label-width="200px" @submit.native.prevent>
...
require('@/business/platform/codemirror/addon/hint/formula-hint')
require('@/business/platform/codemirror/mode/formula/formula-mode')
