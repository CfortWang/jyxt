<template>
  <div class="main-container">
    ...
    <ibps-link
      ...
      ref="printResult"
      text="人员技术档案"
      link="resolve([{event:'afterSubmit',logic:`resolve({openType:'dialog',url:'${options.reportPash}03人员培训和考核程序/SGJS-CX-03-07B 人员能力监控评价表.rpx&rynljkpj.id=${options.formData.id}'})` }])"
      show-type="button"
      text-type="fixed"
...
<script>
import { queryPageList, remove } from '@/api/demo/codegen/renYuanNengLiJianKong'
  ...
  data() {
    return {
      ...
      listConfig: {
        // 表格字段配置
        columns: [
          { prop: 'jiShuNengLiBi', label: '技术能力表现' },
