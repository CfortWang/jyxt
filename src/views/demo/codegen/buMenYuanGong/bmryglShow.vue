<template>
 <div class="ryjbShow">
  <div class="ryjbShow-Cont">
 <!--顶部按钮 请根据实际添加-->
     <div class="dynamic-form" style="background-color: #FFFFFF;">
        ...
        <div class="form-header">
           <div class="title" >[ {{models.name}} ] 的个人情况</div>
     </div>
     </div>
          ...
          <el-row :gutter="0" justify="start" align="top" class="widget-col" type="flex">
            <el-col :span="6">
              ...
              <el-form-item label="性别" prop="gender">
                <el-select v-model="models.gender"  :readonly="readonly" placeholder="请选择" name="gender" :style="{width:width}" clearable>
            ...
            <el-col :span="6">
              ...
              <el-form-item label="岗位" prop="positions">
                <ibps-user-selector v-model="models.positions" placeholder="请选择" type="position" :multiple="true" store="id"
                   :readonly-text="readonlyText?'text':null" :style="{width:width}" />
              </el-form-item>
     ...
     <!-- <el-col :span="12">
                ...
                <el-col :span="5">
                     <el-form-item
                           ...
                           <ibps-link
                             text="人员基本信息"
                             link="resolve([{event:'afterSubmit',logic:`resolve({openType:'dialog',url:'${options.reportPash}03人员培训和考核程序/SGJS-CX-03-02B 人员基本情况登记表.rpx&user_id=${options.formData.id}'})` }])"
                             show-type="button"
                             text-type="fixed"
                             link-type="javascript"
                             text-javascript=""
                ...
                <el-col :span="5">
                         <el-form-item
                               ...
                               <ibps-link
                                 text="人员技术档案"
                                 link="resolve([{event:'afterSubmit',logic:`resolve({openType:'dialog',url:'${options.reportPash}03人员培训和考核程序/SGJS-CX-03-03B 人员技术档案目录.rpx&id_=${options.formData.id}'})` }])"
                                 show-type="button"
                                 text-type="fixed"
                                 link-type="javascript"
                                 text-javascript=""
                             ...
                             <el-col :span="5">
                                      <el-form-item
                                            ...
                                            <ibps-link
                                              text="业务培训履历"
                                              link="resolve([{event:'afterSubmit',logic:`resolve({openType:'dialog',url:'${options.reportPash}03人员培训和考核程序/SGJS-CX-03-04B 人员培训履历表.rpx&id_=${options.formData.id}'})` }])"
                                              show-type="button"
                                              text-type="fixed"
                                              link-type="javascript"
                                              text-javascript=""
...
<div style=" position: absolute; min-height: 800px; width:100%;margin-top: 20px;">
  <!-- 基本情况-->
        ...
        <div style="background-color: #FFFFFF;padding: 20px;" >
            ...
            <el-row :gutter="0" justify="start" align="top" class="widget-col" type="flex">
              ...
              <el-col :span="8">
                ...
                <el-form-item label="职务" prop="xingZhengZhiWu">
...
<HuoJiang v-if="activeIndex == '2'" :userId ="models.id"/>
<LunWen v-if="activeIndex == '3'" :userId ="models.id">  </LunWen>
<JiShu v-if="activeIndex == '4'" :userId ="models.id">  </JiShu>
<JingLi v-if="activeIndex == '5'" :userId ="models.id">  </JingLi>
<PeiXun v-if="activeIndex == '6'" :userId ="models.id">  </PeiXun>
...
<script>
  ...
  export default {
    ...
    computed: {
      formId() {
        return this.$store.getters.userInfo.user.id
      }
    },
    watch: {
      visible: {
