  ...
  >
    ...
    >
      ...
      <el-form-item label="确认时间:" prop="queRenShiJian">
        <el-input v-if="!readonly" v-model="form.queRenShiJian" />
        <span v-else>{{ form.queRenShiJian }}</span>
      </el-form-item>
      <el-form-item label="确认内容:" prop="queRenNeiRong">
        <el-input v-if="!readonly" v-model="form.queRenNeiRong" />
        <span v-else>{{ form.queRenNeiRong }}</span>
      </el-form-item>
...
<script>
import { save, get } from '@/api/demo/codegen/yeWuNengLiQueRen'
