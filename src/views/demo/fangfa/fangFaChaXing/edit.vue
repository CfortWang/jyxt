<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="标准查新时间:" prop="biaoZhunChaXin">
        <el-input v-if="!readonly" v-model="form.biaoZhunChaXin" />
        <span v-else>{{ form.biaoZhunChaXin }}</span>
      </el-form-item>
      <el-form-item label="查新目录:" prop="chaXinMuLu">
        <el-input v-if="!readonly" v-model="form.chaXinMuLu" />
        <span v-else>{{ form.chaXinMuLu }}</span>
      </el-form-item>
      <el-form-item label="查新途径:" prop="chaXinTuJing">
        <el-input v-if="!readonly" v-model="form.chaXinTuJing" />
        <span v-else>{{ form.chaXinTuJing }}</span>
      </el-form-item>
      <el-form-item label="查新情况:" prop="chaXinQingKuan">
        <el-input v-if="!readonly" v-model="form.chaXinQingKuan" />
        <span v-else>{{ form.chaXinQingKuan }}</span>
      </el-form-item>
      <el-form-item label="查新人:" prop="chaXinRen">
        <el-input v-if="!readonly" v-model="form.chaXinRen" />
        <span v-else>{{ form.chaXinRen }}</span>
      </el-form-item>
...
<script>
import { save, get } from '@/api/demo/fangfa/fangFaChaXing'
