  ...
  >
    ...
    >
      <el-form-item label="内容:" prop="neiRong">
        <el-input v-if="!readonly" :rows="8" type="textarea" v-model="form.neiRong" />
...
<script>
import { save, get } from '@/api/demo/shebei/sheBeiDangAn'
  ...
  data() {
    return {
      ...
      form: {
        ...
        updateTime: '',
        neiRong: '',
        jiShuShi: this.$store.getters.userInfo.org.id
      },
      rules: {
