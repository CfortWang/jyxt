...
<script>
import { queryPageList, remove } from '@/api/demo/shebei/sheBeiDangAn'
    ...
    return {
      ...
      listConfig: {
        ...
        columns: [
          ...
          ,{ prop: 'jiShuShi', label: '技术室' ,fieldType: 'slot',slotName:"bianZhiBuMenSelector"}
