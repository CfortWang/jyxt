<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="对应采购计划:" prop="duiYingCaiGou">
        <el-input v-if="!readonly" v-model="form.duiYingCaiGou" />
        <span v-else>{{ form.duiYingCaiGou }}</span>
      </el-form-item>
      <el-form-item label="申请物品:" prop="shenQingWuPin">
        <el-input v-if="!readonly" v-model="form.shenQingWuPin" />
        <span v-else>{{ form.shenQingWuPin }}</span>
      </el-form-item>
    </el-form>
...
<script>
import { save, get } from '@/api/demo/wuliao/wuLiaoYanShou'
