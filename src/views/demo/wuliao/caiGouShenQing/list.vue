...
<script>
import { queryPageList, remove } from '@/api/demo/wuliao/caiGouShenQing'
      ...
      listConfig: {
        ...
        searchForm: {
          forms: [
            ...
            ,{ prop: 'Q^JING_FEI_YU_SUAN_^SL', label: '经费预算' }
            ,{ prop: 'Q^LI_YOU_HE_YONG_TU^SL', label: '理由和用途' }
            ,{ prop: 'Q^WU_PIN_DE_MING_CH^SL', label: '物品的名称、规格、数量' }
            ,{ prop: 'Q^SHI_FOU_GUO_SHEN_^SL', label: '是否过审' }
            ,{ prop: 'Q^WU_PIN_MING_CHENG^SL', label: '物品名称' }
            ,{ prop: 'Q^WU_PIN_GUI_GE_^SL', label: '物品规格' }
            ,{ prop: 'Q^WU_PIN_SHU_LIANG_^SL', label: '物品数量' }
        ...
        columns: [
          ...
          ,{ prop: 'jingFeiYuSuan', label: '经费预算' }
          ,{ prop: 'liYouHeYongTu', label: '理由和用途' }
          ,{ prop: 'wuPinDeMingCh', label: '物品的名称、规格、数量' }
          ,{ prop: 'shiFouGuoShen', label: '是否过审' }
          ,{ prop: 'wuPinMingCheng', label: '物品名称' }
          ,{ prop: 'wuPinGuiGe', label: '物品规格' }
          ,{ prop: 'wuPinShuLiang', label: '物品数量' }
