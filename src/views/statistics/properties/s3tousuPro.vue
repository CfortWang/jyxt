    ...
    <el-container>
      ...
      <el-aside style="border:0px;width: 50%;">
        ...
        <el-aside style="border:0px;width: 37%;">
          ...
          <el-divider content-position="left">{{data.t_complaintBegin.date}} 年度</el-divider>
            投诉总数次数 ：<el-tag>{{data.t_complaintBegin.number}} 次</el-tag>
            <br>
             <el-divider content-position="left">{{data.t_complaintEnd.date}} 年度</el-divider>
            投诉总数次数 ：<el-tag type="danger">{{data.t_complaintEnd.number}} 次</el-tag>
           </div>
