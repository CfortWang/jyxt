    ...
    <div class="app-container">
        <el-row>
                    ...
                    <div class="el-card ibps-desktop-dashboard is-always-shadow jbd-home-card" alias="paddingApprove">
                        ...
                        <div>
                            <el-pagination
                                ...
                                :current-page.sync="pendingPage.page"
            ...
            <el-col :span="12" class="firstcol">
                ...
                <div
                    v-if="!drawer"
                    class="jbd-control-cont"
                    style="background-color: #ddfff1"
                >
                    <el-button
                        type="success"
                ...
                <div class="vue-grid-item cssTransforms">
                    <div
                        class="el-card ibps-desktop-dashboard is-always-shadow jbd-home-card"
                        alias="paddingApprove"
                        style="width: 100%"
                    >
                        <div class="el-card__header">
                            <div class="clearfix">
                        ...
                        <div>
                            <el-pagination
                                @current-change="orverCurrentChange"
                                :current-page.sync="orverPage.page"
                                :page-size="orverPage.limit"
                                layout="total, prev, pager, next"
                                                ...
                                                <div class="el-tab-pane">
                                                    <div class="ibps-pr-10 ibps-list ibps-list-default ibps-list-horizontal ibps-list-split">
                                                        <div class="ibps-list-container">
                                                            <ul
                                                                v-for='(item0,index1) in handledData'
                                                                :key='index1'
                                                                class="ibps-list-items"
                                                            >
                                                                <li
                                                                    class="ibps-list-item" 
                                                                    style="cursor: pointer;"
                                                                    @click="handleLinkClickOrver(item0.id)"
                                                                >
                                                                    <div class="ibps-list-item-meta">
                                                                        <div class="ibps-list-item-meta-avatar">
                                                                            <span class="el-avatar el-avatar--icon el-avatar--circle" style="background:#CC7832;"><i class="el-icon-document-copy"></i></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="ibps-list-item-extra"></div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
        ...
        >
            <el-row>
                <el-col :span="24">
                    <div class="vue-grid-item cssTransforms" style="margin-bottom: 10px">
                        <div
                            class="el-card box-card is-always-shadow jbd-home-card"
                            alias="userInfo"
                            style="display: none"
                        >
                            <div class="el-card__body">
                                <div class="ibps-list-item-meta">
                                    <div class="ibps-list-item-meta-avatar">
                                        <span
                                            class="el-avatar el-avatar--icon el-avatar--circle"
                                            style="
                                                height: 50px;
                                                width: 50px;
                                                line-height: 50px;
                                    ...
                                    <div class="ibps-list-item-meta-content">
                                        <div class="ibps-list-item-meta-title">
                                            <div class="ibps-item-content">
                                                ...
                                                <div slot="label" class="ibps-item-content-label" style="display: none">
                                                    <span style="color: #000000">所属部门<div class="home-text-border">{{ orgName }}</div></span>
                                                    <span style="color: #000000">所处岗位<div class="home-text-border">{{ posName }}</div></span>
                                                    <span style="color: #000000">拥有角色<div class="home-text-border">{{ roleName }}</div></span>
                                                                ...
                                                                <ul class="ibps-list-items">
                                                                    ...
                                                                    <!-- <li class="ibps-list-item" style="cursor: pointer;" v-for='(item,index0) in newsData' :key='index0' @click="handelInteriorClick(item.id)" >
                                                                        ...
                                                                        <div class="ibps-list-item-extra">
                                                                            <div><i class="ibps-icon ibps-icon-dot-circle-o" style="color: rgb(54, 198, 211);"></i>{{ item.userName }} | {{item.publicDate.substring(0,7)}}</div>
                                                                        </div>
                                                                    </li> -->
                                                                    ...
                                                                    >
                                                                        <div class="ibps-list-item-meta">
                                                                            <div class="ibps-list-item-meta-content">
                                                                                <div class="ibps-list-item-meta-title">
                                                                                    <a class="el-link el-link--primary">
                                                                                        <span class="el-link--inner jbd-font-style" style="font-size: 14px; font-family: KaiTi;">
                                                                                            <div><span>{{ item.templatename_ }}</span></div>
                                                                                        </span>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="ibps-list-item-extra">
                                                                            <div><i class="ibps-icon ibps-icon-dot-circle-o" style="color: rgb(54, 198, 211)"></i>{{ item.NAME_ }} | {{ item.bian_zhi_shi_jian }}</div>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
            ...
            <!-- <el-row>
                <el-col :span="24" style="margin-top: 5px;">
                    <div  class="vue-grid-item cssTransforms">
                        <div
                            class="el-card ibps-desktop-dashboard is-always-shadow"
                            alias="paddingApprove"
                            style="height:434px;width: 100%;"
                        >
                            <div class="el-card__body">
    ...
    export default {
        ...
        methods: {
            ...
            handleLinkClick(cont) {
                ...
                this.processName = this.getProjectName(cont.procDefKey)
