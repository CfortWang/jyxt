    ...
    <el-row>
      ...
      <el-col  :span="12"  class="firstcol">
        ...
        <div  class="jbd-control-cont"  v-if="!drawer" style="background-color: #DDFFF1;">
          <el-button  type="success" icon="el-icon-caret-right" style="width: 100%;height: 100%;"   plain circle   @mouseover.native ="handleClose()"  @mouseleave.native="handleClose()"/>
         
         <p style="color: #000000; font-size: 14px;">公</p>
          <p style="color: #000000; font-size: 14px;">告</p>
        </div>
          <div  class="vue-grid-item cssTransforms">
             <div  class="el-card ibps-desktop-dashboard is-always-shadow jbd-home-card"  alias="paddingApprove" style=" width: 100%;">
               <div class="el-card__header">
                <div class="clearfix">
    ...
    <el-row>
          <el-col  :span="24" >
                <div  class="vue-grid-item cssTransforms" style="margin-bottom: 10px;">
                  <div  class="el-card box-card is-always-shadow jbd-home-card"  alias="userInfo" style=" display: none;" >
                   <div class="el-card__body">
                       <div class="ibps-list-item-meta">
                         <div class="ibps-list-item-meta-avatar">
                            <span class="el-avatar el-avatar--icon el-avatar--circle" style="height: 50px; width: 50px; line-height:  50px; font-size:  50px; color: rgb(192, 196, 204); background: rgb(255, 255, 255);">
...
-->
                                              <li  class="ibps-list-item" style="cursor: pointer;" v-for='(item,index0) in newsDataCms.dataResult' :key='index0' @click="handelInteriorClick(item.sendtime_)" >
                                                <div  class="ibps-list-item-meta">
                                                  <div class="ibps-list-item-meta-content">
                                                    <div class="ibps-list-item-meta-title">
                                                      <a class="el-link el-link--primary">
                                                ...
                                                <div class="ibps-list-item-extra">
                                                    ...
                                                    <i  class="ibps-icon ibps-icon-dot-circle-o" style="color: rgb(54, 198, 211);"></i>
                                                            {{ item.tong_zhi_ren_ }} |
                                                            {{item.create_time_.substring(0,10)}}
                                                    </div>
                                                </div>
                                              </li>
...
.el-completing{background: #409EFF!important;}
  .el-col {
  min-height: 1px;

}

.firstcol{padding-right: 10px;}

.el-nothing{font-size: 13px;}
