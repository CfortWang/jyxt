  ...
  series: [
    {
      ...
      itemStyle: {
        color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
          { offset: 0, color: '#9BCA63' },
          { offset: 0.5, color: '#9BCA63' },
          { offset: 1, color: '#9BCA63' }
        ])
      },
      emphasis: {
        itemStyle: {
...
const zoomSize = 6;
s5renYuanJianDu.on('click', function (params) {
  console.log(dataAxis[Math.max(params.dataIndex - zoomSize / 2, 0)]);
  s5renYuanJianDu.dispatchAction({
    type: 'dataZoom',
