    ...
    >
      ...
      <div v-show="stepActive===1" class="boType">
        ...
        <el-form-item label="步骤说明：">
          <div class="step-desc">
            <el-row>
              <el-col :span="24">1、新建:</el-col>
              <el-col :span="24" class="ibps-pl-20">1.1 跳转编辑页面；</el-col>

              <el-col :span="24">2、现有BO:</el-col>
              <el-col :span="24" class="ibps-pl-20">2.1、选择现有BO；</el-col>
              <el-col :span="24" class="ibps-pl-20">2.2、跳转到编辑页面；</el-col>

              <el-col :span="24">3、离线表:</el-col>
              <el-col :span="24" class="ibps-pl-20">3.1、有对应BO:</el-col>
              <el-col :span="24" style="padding-left:40px;">3.1.1、选择现有BO；</el-col>
              <el-col :span="24" style="padding-left:40px;">3.1.2、跳转到编辑页面；</el-col>
              <el-col :span="24" class="ibps-pl-20">3.2、无对应BO:</el-col>
              <el-col :span="24" style="padding-left:40px;">3.1.1、选择现有BO；</el-col>
              <el-col :span="24" style="padding-left:40px;">3.1.2、选择离线表；</el-col>
              <el-col :span="24" style="padding-left:40px;">3.1.3、跳转到编辑页面；</el-col>
            </el-row>
          </div>
        </el-form-item>
      </div>
...
export default {
  ...
  methods: {
    ...
    externalInput(value) {
      ...
      this.form.external = this.$utils.isEmpty(value) ? '' : JSON.stringify(arr)
    },
    resetFields() {
      this.stepActive = 1
