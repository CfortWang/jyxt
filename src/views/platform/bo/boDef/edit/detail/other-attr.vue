<template>
  <el-form ref="form" label-width="130px" @submit.native.prevent>
    <el-form-item label="展示类型:" prop="struType">
      <el-select v-model="form.struType" :disabled="readonly" placeholder="请选择" style="width:100%;" @change="handleStruType">
        <el-option
