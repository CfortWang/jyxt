      ...
      listConfig: {
        ...
        columns: [
         /* { prop: 'subject', label: '任务标题', link: 'dialog', width: 250 }, */
          ...
          { prop: 'name', label: '投诉人' , width: 120 },
          { prop: 'tUser', label: '受理人' , width: 80},
          { prop: 'endTime', label: '受理时间', sortable: 'custom', dateFormat: 'yyyy-MM-dd', width:150 },
        ],
        rowHandle: {
          actions: [/* {
