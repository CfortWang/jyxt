      ...
      listConfig: {
        ...
        searchForm: {
          forms: [
            ...
            { prop: 'Q^NOTIFIER_^S', label: '发送人', fieldType: 'slot', slotName: 'notifierSelect' },
            {
        ...
        columns: [
          ...
          { prop: 'notifyTitle', label: '通知标题', sortable: 'custom', link: 'dialog' },
          { prop: 'procDefName', label: '流程定义' },
          { prop: 'nodeName', label: '节点' },
          { prop: 'notifierName', label: '发送人' },
