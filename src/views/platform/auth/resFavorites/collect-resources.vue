...
<script>
import { findUserResTreeCheckedBySys, saveFavorites } from '@/api/platform/auth/resources'
...
export default {
  ...
  methods: {
    ...
    loadTreeData() {
      ...
      findUserResTreeCheckedBySys({ 'systemId': this.$store.getters.systemid }).then(response => {
