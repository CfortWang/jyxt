<template>
  <el-dialog
    ...
    append-to-body
    top="5vh"
    custom-class="client-form-dialog"
    @open="getFormData"
    @close="closeDialog"
  >
    <el-form
    ...
    >
      ...
      <el-form-item v-if="readonly" label="过期时间:" prop="expireTime">
  ...
  methods: {
    ...
    nopass() {
      this.$prompt('请输入理由', '提示', {
        ...
        this.batchAudit(this.formId, true, value, this.form.expireTime)
      })
    },
    batchAudit(ids, nopass, cause, expireTime) {
      doAuditBatch({
        authClientIds: ids,
        nopass: nopass || null,
        cause: cause || null,
