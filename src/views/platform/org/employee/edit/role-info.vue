<template>
  <el-row :gutter="10">
    ...
    <el-col v-if="!readonly" :span="3">
      ...
      <el-button type="info" icon="el-icon-d-arrow-left" class="ibps-ml-10 ibps-mt-10" style="margin-top:10px;" @click="handleClear(newRoleData)">清空</el-button>
    </el-col>
...
export default {
  ...
  methods: {
    init() {
      if (this.$refs.elTree) { this.$refs.elTree.setCheckedNodes([]) }
